...
export default function Page() {
  ...
  return (
    <main>
      ...
      <section className="investor-cta" id="investors"><div className="wrap cta-inner"><div><p className="kicker">Investor portal</p><h2>Capital that moves<br /><em>with purpose.</em></h2></div><div><p>This overview is prepared for qualified institutional investors and development finance institutions. Request the full memorandum and data room access from the investment team.</p><a className="button button-gold" href="mailto:geopesa2015@gmail.com">Request investor access <ArrowUpRight size={17} /></a><div className="contact-summary"><span><b>Phone</b>+254 20 2100366<br />+254 716 080871</span><span><b>Email</b>geopesa2015@gmail.com</span></div></div></div></section>
