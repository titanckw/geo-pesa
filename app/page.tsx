  ...
  return (
    <main>
      ...
      <section className="hero" id="top">
        ...
        <div className="hero-ticker"><div className="wrap ticker-grid"><div><SplitFlapText text="$300M" fontSize={31} padTo={6} /><span>Target financing capacity</span></div><div><SplitFlapText text="14–17%" fontSize={31} padTo={6} /><span>Target net yield to investors</span></div><div><SplitFlapText text="3" fontSize={31} padTo={6} /><span>Core business pillars</span></div><div><SplitFlapText text="6+" fontSize={31} padTo={6} /><span>Countries of deployment</span></div></div></div>
      </section>
